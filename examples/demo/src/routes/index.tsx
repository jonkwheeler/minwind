...
const CARDS: Array<{ title: string; blurb: string }> = [
  {
    title: "Rename",
    blurb: "Every utility class becomes a short, stable name.",
  },
  ...
  return (
    <section>
      ...
      <p class="mb-8 max-w-prose leading-7 opacity-80">
        minwind compresses Tailwind classnames at build time — in the markup, in
        the JavaScript, and in the stylesheet, together.
      </p>
