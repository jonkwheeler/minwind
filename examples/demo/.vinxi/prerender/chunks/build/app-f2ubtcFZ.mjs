...
var gt = ["<div", ' class="dune small brook glade byte isle"><header class="small bytes travel far"><!--$-->', '<!--/--><nav class="small bytes willow dog">', '</nav></header><main class="gone with">', '</main><footer class="small bytes travel breeze far dog glen"><span>classname compression, dogfooded</span><button>toggle theme</button></footer></div>'];
function wt(t) {
  return ssr(gt, ssrHydrationKey(), escape(createComponent(Ne, { href: "/", class: "ridge a through fox", children: "minwind demo" })), escape(createComponent(Ne, { href: "/about", class: "flag ember", children: "about" })), escape(t.children));
}
function At() {
...
//# sourceMappingURL=app-f2ubtcFZ.mjs.map
