...
Commands:
  ...
  report [path-to-report.json]         Summarize the latest minwind build
                                       report (default
                                       .output/minwind/report.json)
  prominence <build-output-directory>  Write a prominence manifest (class
                                       token -> first-seen DOM index) for
